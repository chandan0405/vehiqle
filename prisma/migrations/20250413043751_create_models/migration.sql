...
-- CreateEnum
CREATE TYPE "CarStatus" AS ENUM ('AVAILABLE', 'UNAVAIALBALE', 'SOLD');
...
CREATE TABLE "DealerShipInfo" (
    ...
    "address" TEXT NOT NULL DEFAULT '12 wazirabaad  New Delhi  110054',
    "phone" TEXT NOT NULL DEFAULT '8222222000',
    "email" TEXT NOT NULL DEFAULT 'dummy@vehiql.com',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
